             ...
             <>
               ...
               <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                  {currentImages.map((img) => (
                     <div key={img.id} className="group relative h-72 rounded-2xl overflow-hidden bg-slate-200 dark:bg-slate-900 shadow-sm hover:shadow-xl transition duration-500">
                        <Image 
                          src={img.imageUrl} 
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition duration-300 flex flex-col justify-end p-6">
                           <span className="text-xs font-bold text-primary bg-white/90 px-2 py-1 rounded w-fit mb-2">{img.category}</span>
