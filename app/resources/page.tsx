       ...
       <section className="pt-48 pb-20 px-6 bg-slate-900 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="max-w-xl mx-auto relative text-slate-900">
               ...
               <input type="text" placeholder="Search..." className="w-full pl-12 p-4 rounded-full bg-white outline-none focus:ring-4 ring-primary/30" />
            </div>
          </div>
       </section>
                  ...
                  {downloads.map(res => (
                     <div key={res.id} className="flex gap-4 p-6 bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-100 dark:border-slate-800 hover:shadow-md transition">
                        ...
                        <div>
                           ...
                           <a href={res.fileUrl} target="_blank" className="px-4 py-2 bg-slate-100 dark:bg-slate-800 text-xs font-bold rounded hover:bg-slate-200 dark:hover:bg-slate-700 transition text-slate-900 dark:text-white">
