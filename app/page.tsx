...
import { ArrowRight, CheckCircle, MapPin, Calendar, Users, Star, Briefcase, BookOpen } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
          <div>
            ...
            <h1 className="text-5xl md:text-6xl font-bold font-heading mb-6 leading-tight text-slate-900 dark:text-white">
              Where HR Careers Grow, <span className="text-primary">Leaders Emerge</span>, and Community Thrives
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Link href="/events" className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-900 dark:text-white px-8 py-4 rounded-lg font-bold transition">
                Explore Programs
              </Link>
            </div>

            {/* UPDATED STATS FROM PDF */}
            <div className="mt-12 flex flex-wrap gap-12">
               ...
               <div>
                  ...
                  <div className="text-sm text-slate-500">Applicants Supported</div>
               </div>
               <div>
                  <div className="text-3xl font-bold text-slate-900 dark:text-white">Weekly</div>
                  <div className="text-sm text-slate-500">Growth Stories</div>
               </div>
            </div>
          </div>
          
          {/* Hero Image - Placeholder for your Real Cloudinary Image */}
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-slate-100 dark:border-slate-800">
               {/* REPLACE THIS SRC WITH YOUR REAL CLOUDINARY URL */}
               <img 
      ...
      <section className="py-20 bg-white dark:bg-slate-950">
         <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6 font-heading">
               A Community Built on Growth, <br/> Connection, and Possibility
            </h2>
            <div className="text-slate-600 dark:text-slate-300 text-lg leading-relaxed mb-8 space-y-6 text-left md:text-center">
               <p>
                  Founded on <strong>July 2, 2018</strong>, HR Mentorship began with one vision: to create a safe, structured, supportive space where HR professionals could learn, grow, and access resources that truly transform their careers.
               </p>
               <p>
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left mb-10">
                <div className="p-4 bg-slate-50 dark:bg-slate-900 rounded-lg">
                    ...
                    <h3 className="font-bold mb-1">Competence</h3>
                    <p className="text-sm text-slate-500">Lead with competence and character</p>
                </div>
                <div className="p-4 bg-slate-50 dark:bg-slate-900 rounded-lg">
                    <Users className="text-primary mb-2" size={24} />
                    <h3 className="font-bold mb-1">People-First</h3>
                    <p className="text-sm text-slate-500">Practice people-first leadership</p>
                </div>
                <div className="p-4 bg-slate-50 dark:bg-slate-900 rounded-lg">
                    <Briefcase className="text-primary mb-2" size={24} />
                    <h3 className="font-bold mb-1">Innovation</h3>
                    <p className="text-sm text-slate-500">Build ethical, high-performing workplaces</p>
                </div>
            </div>
      ...
      <section className="py-24 bg-slate-50 dark:bg-slate-900/50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
             <h2 className="text-3xl md:text-4xl font-bold mb-4 font-heading">Workshops & Learning Experiences</h2>
             <p className="text-slate-500 text-lg max-w-2xl mx-auto">
               From weekly learning sessions to paid masterclasses, global webinars, study groups, and certification support, our programs drive real growth.
             </p>
             <div className="flex flex-wrap justify-center gap-3 mt-6 text-sm font-medium text-slate-600 dark:text-slate-400">
                <span className="bg-white dark:bg-slate-800 px-3 py-1 rounded-full border">HR Book Review</span>
                <span className="bg-white dark:bg-slate-800 px-3 py-1 rounded-full border">Certification Prep</span>
                <span className="bg-white dark:bg-slate-800 px-3 py-1 rounded-full border">HR Strategy</span>
                <span className="bg-white dark:bg-slate-800 px-3 py-1 rounded-full border">Analytics</span>
             </div>
          </div>
      ...
      <section className="py-24 bg-white dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-6">
           <div className="text-center mb-12">
              ...
              <p className="text-slate-500 text-lg">HR Mentorship is where professional growth meets real human community.</p>
           </div>
           
           <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {/* REPLACE THESE WITH REAL CLOUDINARY IMAGES */}
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white">
           <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              Ready to Grow Your <span className="text-purple-300">HR Career?</span>
           </h2>
           <p className="text-white/80 text-lg mb-10 max-w-2xl mx-auto">
              Join thousands of HR professionals who are transforming their careers.
           </p>
