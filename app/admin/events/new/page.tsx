...
import { ImagePlus, Calendar, MapPin } from "lucide-react";
    ...
    <div className="max-w-2xl mx-auto py-10 px-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-white p-8 rounded-xl shadow-sm border">
        ...
        <div>
          ...
          <input name="title" required className="w-full border p-3 rounded-lg" placeholder="e.g. HR Summit 2025" />
        </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
             ...
             <div className="relative">
                ...
                <input name="date" type="date" required className="w-full border p-3 pl-10 rounded-lg" />
             </div>
          </div>
          <div>
             ...
             <div className="relative">
                ...
                <input name="location" required className="w-full border p-3 pl-10 rounded-lg" placeholder="Zoom / Lagos" />
             </div>
          </div>
        </div>

        <button disabled={loading || uploading} className="w-full bg-black text-white py-3 rounded-lg hover:bg-gray-800 disabled:opacity-50">
