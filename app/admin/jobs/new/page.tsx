...
export default function NewJobPage() {
  ...
  return (
    <div className="max-w-xl mx-auto py-10 px-6">
      ...
      <h1 className="text-3xl font-bold mb-6 text-slate-900 dark:text-white">Post New Job</h1>
      
      <form onSubmit={handleSubmit} className="space-y-4 bg-white dark:bg-slate-900 p-8 rounded-xl shadow-sm border dark:border-slate-800">
        <div>
          <label className="block text-sm font-medium mb-1 text-slate-700 dark:text-slate-300">Job Title</label>
          <input name="title" required className="w-full border dark:border-slate-700 p-3 rounded-lg bg-white dark:bg-slate-950 text-slate-900 dark:text-white" />
        </div>
        <div>
          <label className="block text-sm font-medium mb-1 text-slate-700 dark:text-slate-300">Company</label>
          <input name="company" required className="w-full border dark:border-slate-700 p-3 rounded-lg bg-white dark:bg-slate-950 text-slate-900 dark:text-white" />
        </div>
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input name="location" required className="w-full border dark:border-slate-700 p-3 rounded-lg bg-white dark:bg-slate-950 text-slate-900 dark:text-white" placeholder="e.g. London" />
          </div>
        </div>
